...
它**默认是关闭的**，随 Windows 11 的 KB5120998 更新一起提供（24H2 / 25H2，从家庭版到教育版都支持）。如果你在安全中心里暂时没看到这个开关，不用着急——它目前还在**预览阶段**、分批推送，通常**预览体验计划的设备会先拿到**（所以正式版的设备看不到它属于正常现象）。
...
> [!NOTE] 一句话总结
>  UAC 是"门锁"，管理员保护是"门锁 + 刷脸"。在习惯 UAC 弹窗之后，这大概就是 Windows 提权机制的下一个形态。
